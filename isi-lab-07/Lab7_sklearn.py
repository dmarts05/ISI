...
if __name__ == "__main__":
    ...
    for i, (train_index, test_index) in enumerate(kf.split(X)):
        proportion_class_0_train = np.sum(y[train_index] == 0) / train_index.size
        proportion_class_1_train = 1 - proportion_class_0_train
        proportion_class_0_test = np.sum(y[test_index] == 0) / test_index.size
    ...
    for train_index, test_index in skf.split(X, y):
        ...
        # them
        # ====================== YOUR CODE HERE ======================
        accuracy_fold = accuracy_score(y_test_fold, y_test_assig_fold)
    ...
    scores = cross_validate(clf, X, y, cv=K, scoring=["accuracy", "f1"])
    # ============================================================
    ...
    print(
        "AVERAGE FSCORE = {:4.3f}; STD FSCORE = {:4.3f}".format(
