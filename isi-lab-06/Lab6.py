...
def calculate_cost_log_reg(y, y_hat):
    ...
    # ====================== YOUR CODE HERE ======================
    e = 1e-10
    cost_i = y * np.log(y_hat + e) + (1 - y) * np.log(1 - y_hat + e)
    # ============================================================
...
def train_logistic_regression(
    x_train, y_train, alpha_train, verbose=True, max_iter=100
):
    """
    ...
    theta_train = np.random.uniform(low=a, high=b, size=(1, 1 + np.shape(x_train)[1]))
    ...
    for i in range(m):
        ...
        # patterns
        # ====================== YOUR CODE HERE ======================
        cost_pattern_i = calculate_cost_log_reg(y_train[i], h_i)
        # ============================================================
        total_cost += cost_pattern_i

    # b. Calculate the total cost
    # ====================== YOUR CODE HERE ======================
    cost_values[0, 0] = total_cost / -m
    # ============================================================
    ...
    for num_iter in range(max_iter):
        ...
        for j in range(len(theta_train)):
            ...
            theta_train[j] = theta_old[j] - alpha_train * average_error
            # ============================================================
        ...
        # b. Calculate the total cost
        # ====================== YOUR CODE HERE ======================
        cost_values[0, num_iter + 1] = total_cost / -m
        # ============================================================
    ...
    if verbose:
        ...
        plt.ylabel("Cost J")
        plt.title(
            r"Cost function over the iterations with $\alpha=${}".format(alpha),
            fontsize=14,
        )
        plt.show()
...
def classify_logistic_regression(x_test, theta_classif):
    ...
    for i in range(num_elem_test):
        ...
        # ====================== YOUR CODE HERE ======================
        # Calculate the probability for the i-th pattern to belong to the
        # positive class
...
if __name__ == "__main__":
    ...
    # Accuracy
    # ====================== YOUR CODE HERE ======================
    accuracy = np.sum(y_test == y_test_assig) / len(y_test)
    # ============================================================
    print("***************")
    print(
